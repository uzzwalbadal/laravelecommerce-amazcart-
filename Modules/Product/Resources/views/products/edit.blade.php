                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <label class="primary_input_label" for=""><strong>{{ __('common.type') }}</strong>@if($product->product_type == 2) ({{__('product.variant_product_is_not_changable_to_single_product')}}) @elseif($product->product_type == 1 && !product_attribute_editable($product->id)) ({{__('product.change_not_possible_for_use')}}) @endif<span
                                                        class="text-danger">*</span></label>
                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                    <li>
                                                        <label data-id="bg_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" id="single_prod" value="1" {{$product->product_type == 1?'checked':''}} {{($product->product_type == 2 || !product_attribute_editable($product->id))?'disabled':''}}
                                                    ...
                                                    <li>
                                                        <label data-id="color_option" class="primary_checkbox d-flex mr-12">
                                                            <input name="product_type" value="2" id="variant_prod" {{$product->product_type == 2?'checked':''}} {{($product->product_type == 2 || !product_attribute_editable($product->id))?'disabled':''}}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="primary_input mb-15">
                                                ...
                                                <input class="primary_input_field" name="product_name" id="product_name"
                                                    ...
                                                    value="{{ old('product_name')?old('product_name'):$product->product_name }}" required="1">
                                        ...
                                        <div class="col-lg-12 attribute_div">
                                            <div class="primary_input mb-25">
                                                <label class="primary_input_label"
                                                    for=""><strong>{{ __('product.attribute') }}</strong> @if(!product_attribute_editable($product->id)) ({{__('product.attribute_add_not_possible_for_this_product')}}) @endif</label>
                                                <select name="choice_attributes[]" id="choice_attributes" @if(!product_attribute_editable($product->id)) disabled @endif
                                        ...
                                        <div class="col lg-12">
                                            <div class="customer_choice_options" id="customer_choice_options">
                                                @foreach ($product->variations->unique('attribute_id') as $key => $choice_option)
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <input type="hidden" name="choice_no[]" id="attribute_id_{{$choice_option->attribute_id}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 digital_file_upload_div_edit" style="display: {{($product->is_physical == 1 || $product->product_type == 2)?'none':'block'}};">
                                            <div class="primary_input mb-25">
                                                ...
                                                <label class="primary_input_label"
                                                    for="">{{ __('product.program_file_upload') }} <small>
                                                        @if($digital_file)
                                                        <a class="link_color" href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}"
                                                            download>{{__('product.download_link')}}</a> @endif </small> </label>
                                        ...
                                        <div class="col-lg-4" id="meta_image_div">
                                            ...
                                            @endif
                                                ...
                                                <div class="meta_img_div">
                                                    <img id="MetaImgDiv"
                                                         src="{{   showImage( $product->meta_image ?$product->meta_image: 'backend/img/default.png') }}"
                                                         alt="">
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-12">
                                            <div class="thumb_img_div">
                                                <img id="ThumbnailImg"
                                                    src="{{ showImage($product->thumbnail_image_source ? $product->thumbnail_image_source : 'backend/img/default.png') }}"
                                                    alt="">
                                            </div>
                                        </div>
                                                ...
                                                @if (!empty($product->gallary_images))
                                                    @foreach ($product->gallary_images as $image)
                                                        <div class="galary_img_div">
                                                            <img class="galaryImg" src="{{ showImage($image->images_source) }}" alt="">
                                                        </div>
                                                    @endforeach
                                                @endif
