    ...
    <div class="box_header_right">
        <div class=" float-none pos_tab_btn justify-content-start">
            ...
            <ul class="nav nav_list" role="tablist">
                ...
                @if(isModuleActive('Bkash') && @$gateway_activations->where('method', 'Bkash')->first()->active_status == 1)
                    <li class="nav-item mb-2">
                        <a class="nav-link @if(@$methods[0]->method == 'Bkash') active show @endif" href="#bkashTab" role="tab" data-toggle="tab" id="1"
                           aria-selected="true">{{__('payment_gatways.bkash')}}</a>
                    </li>
                @endif

                @if(isModuleActive('SslCommerz') && @$gateway_activations->where('method', 'SslCommerz')->first()->active_status == 1)
                    <li class="nav-item mb-2">
                        <a class="nav-link @if(@$methods[0]->method == 'SslCommerz') active show @endif" href="#SslCommerzTab" role="tab" data-toggle="tab" id="1"
                           aria-selected="true">{{__('payment_gatways.ssl_commerz')}}</a>
                    </li>
                @endif

                @if(isModuleActive('MercadoPago') && @$gateway_activations->where('method', 'Mercado Pago')->first()->active_status == 1)
                    <li class="nav-item mb-2">
                        <a class="nav-link @if(@$methods[0]->method == 'Mercado Pago') active show @endif" href="#MercadoPagoTab" role="tab" data-toggle="tab" id="1"
...
<div class="col-xl-12">
    <div class="white_box_30px mb_30">
        <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade @if(@$methods[0]->method == 'PayStack') active show @endif" id="paystackTab">
                    <div class="box_header common_table_header ">
                        <div class="main-title d-md-flex">
                            ...
                            <ul class="d-flex">
                                <div class="img_logo_div">
                                    <img src="{{ showImage(@$gateway_activations->where('method', 'PayStack')->first()->logo) }}" alt="">
                                </div>
                            </ul>
                        </div>
                    </div>
            ...
            @if(isModuleActive('Bkash') &&  @$gateway_activations->where('method', 'Bkash')->first()->active_status == 1)
                <div role="tabpanel" class="tab-pane fade @if($methods[0]->method == 'Bkash') active show @endif" id="bkashTab">
                    <div class="box_header common_table_header ">
                        <div class="main-title d-md-flex">
            ...
            @if(isModuleActive('SslCommerz') &&  @$gateway_activations->where('method', 'SslCommerz')->first()->active_status == 1)
                <div role="tabpanel" class="tab-pane fade @if($methods[0]->method == 'SslCommerz') active show @endif" id="SslCommerzTab">
                    <div class="box_header common_table_header ">
                        <div class="main-title d-md-flex">
            ...
            @if(isModuleActive('MercadoPago') &&  @$gateway_activations->where('method', 'Mercado Pago')->first()->active_status == 1)
                <div role="tabpanel" class="tab-pane fade @if($methods[0]->method == 'Mercado Pago') active show @endif" id="MercadoPagoTab">
                    <div class="box_header common_table_header ">
                        <div class="main-title d-md-flex">
