            ...
            <div class="col-lg-6 col-xl-4">
                @if(config('app.sync'))
                    <div class="d-flex justify-content-center mt-20 grid_gap_5 flex-wrap">
                        ...
                        @if($customer_email)
                            <button class="btn_1" id="customer" data-email="{{$customer_email}}">{{ __('common.customer') }}</button>
                        @endif
                        @if (isModuleActive('MultiVendor') && $seller_email)
                            <button class="btn_1 mt_sm_0" id="seller" data-email="{{$seller_email}}">{{ __('common.seller') }}</button>
                        @endif
                    </div>
                @endif
                <br>
                <div class="register_form_iner">
                    <div class="login_logo text-center mb-3">
                        <a href="{{url('/')}}"><img src="{{asset(asset_path(app('general_setting')->logo))}}" alt=""></a>
                    </div>
