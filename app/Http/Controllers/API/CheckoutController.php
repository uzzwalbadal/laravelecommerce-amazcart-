...
class CheckoutController extends Controller
{
    ...
    public function list(Request $request){
        ...
        if(isModuleActive('MultiVendor')){
            $query = $query->with('seller.SellerBusinessInformation', 'customer.customerShippingAddress', 'giftCard', 'product.product.product', 'product.sku', 'product.product_variations.attribute', 'product.product_variations.attribute_value.color')->where('is_select', 1)->get();
        }else{
            $query = $query->with('customer.customerShippingAddress', 'giftCard', 'product.product.product', 'product.sku', 'product.product_variations.attribute', 'product.product_variations.attribute_value.color')->where('is_select', 1)->get();
        }
