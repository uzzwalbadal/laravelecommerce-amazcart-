                            ...
                            <div class="col-md-6 col-lg-6">
                                <table class="table-borderless clone_line_table">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="mailto:{{($order->customer_id) ? $order->shipping_address->email : $order->guest_info->billing_email}}">: {{($order->customer_id) ? $order->shipping_address->email : $order->guest_info->shipping_email}}</a></td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.phone')}}</td>
                                        <td>: {{($order->customer_id) ? $order->shipping_address->phone : $order->guest_info->billing_phone}}</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="row mt-30">
                            <div class="col-md-6 col-lg-6">
                                <table class="table-borderless clone_line_table">
                                    ...
                                    <tr>
                                        <td>{{__('common.email')}}</td>
                                        <td><a href="mailto:{{($order->customer_id) ? $order->shipping_address->email : $order->guest_info->shipping_email}}">: {{($order->customer_id) ? $order->shipping_address->email : $order->guest_info->shipping_email}}</a></td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.phone')}}</td>
                                        <td>: {{($order->customer_id) ? $order->shipping_address->phone : $order->guest_info->shipping_phone}}</td>
                                    </tr>
                                    <tr>
                                        <td>{{__('common.address')}}</td>
                        ...
                        <div class="row mt-30">
                            ...
                            <div class="offset-lg-3 col-lg-3">
                                <table class="table-borderless clone_line_table">
                                    ...
                                    <tr>
                                        <td class="info_tbl">{{__('common.tax')}}/GST</td>
