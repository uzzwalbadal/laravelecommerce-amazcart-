    ...
    <div class="col-lg-4 col-xl-3 col-sm-6 col-md-6 single_product_item">
        <div class="single_product_list product_tricker">
          <div class="product_img">
            <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}" class="product_img_iner">
          ...
          <div class="product_text">
            <h5>
              <a href="{{singleProductURL(@$product->product->seller->slug, @$product->product->slug)}}">@if(@$product->product->product_name) {{substr(@$product->product->product_name,0,28)}} @if(strlen(@$product->product->product_name) > 28)... @endif @else {{substr(@$product->product->product->product_name,0,28)}} @if(strlen(@$product->product->product->product_name) > 28)... @endif @endif</a>
            </h5>
