...
class SidebarManagerController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            if ($role_id == 'seller') {
                $PermissionList = Sidebar::where('user_id',auth()->id())->orderBy('position','asc')->whereIn('module_id', ['7','13','30','15','21','25','26','27','28','29','32','34','41'])->get();
                $subMenuList = $PermissionList->where('type', 2)->whereIn('sidebar_id', ['191','192','193','194','195','30','31','61','62', '135','72','106','124','125','126','127','128','129','130','131','152','153','154','155','156','167']);
            }else{
