    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            if($role){
                ...
                if ($role->type == 'seller') {
                    $PermissionList = Permission::whereIn('module_id',['2','11','12','17','24','31','25','15','29','28','35','37','44'])->get();
                    $subModuleList = $PermissionList->where('type', 2)->whereIn('id', ['489','498','317','318', '514','505','506','507','508',
                    '509','510','511','163','164','165','166','167','154','155','156','157','158','159','160','161','17','18','19','20','21',
                    '22','23','24','25','492','493','494','495','532','533','534','535','536','569','571','574','609','615','625','619','620','621','624','364','681','687','679','690']);
