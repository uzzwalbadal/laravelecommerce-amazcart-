@push('scripts')
    ...
    (function($) {
                    ...
                    if(response == 1){
                        $('#meta_image_div').html(
                            `<div class="meta_img_div">
                                <img id="MetaImgDiv" src="{{ showImage('backend/img/default.png') }}"alt="">
                            </div>
                            `
                        );
        ...
        $(".lodeMoreRelatedSale").on('click',function() {
            ...
            Rpage++;
            var new_url = '/products/get-related-product-for-admin?except_id='+product_id+'&page=';
        ...
        $(".lodeMoreUpSale").on('click',function() {
            event.preventDefault();
            Upage++;
            var new_url = '/products/get-upsale-product-for-admin?except_id='+product_id+'&page=';
        ...
        $(".lodeMoreCrossSale").on('click',function() {
            event.preventDefault();
            Cpage++;
            var new_url = '/products/get-cross-sale-product-for-admin?except_id='+product_id+'&page=';
