                                                        ...
                                                        <ul>
                                                            <li class="mb-0">
                                                                <label class="primary_bulet_checkbox">
                                                                    <input type="radio" data-cost="{{$cost}}" class="shipping_method" name="shipping_method" value="{{$shipping->id}}" {{$key == 0?'checked':''}}>
                                                ...
                                                <div class="standard_shiping_box d-flex align-items-center justify-content-between">
                                                    <div class="product_ceck m-0">
                                                        <ul>
                                                            <li class="mb-0">
                                                                <label class="primary_bulet_checkbox">
                                                                    <input type="radio" data-cost="{{0}}" class="shipping_method" name="shipping_method" value="{{1}}" checked>
                                                                    <span class="checkmark"></span>
                                                                </label>
