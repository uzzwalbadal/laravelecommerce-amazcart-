        ...
        @foreach($cartData as $key => $cartItems)
            ...
            @endphp
                ...
                <div class="card mb-10">
                    ...
                    <input type="hidden" name="delivery_date[]" value="@if($dayOrOur == 'days' || $dayOrOur == 'Days' ||$dayOrOur == 'Day'){{__('Est arrival date')}}: {{$start_date}} - {{$end_date}}@elseif($dayOrOur == 'hrs' || $dayOrOur == 'Hrs'){{__('Est arrival time')}}: {{$start_date}} - {{$end_date}}@else @endif">
...
<div class="col-lg-2 mb-50">
    <table class="table-borderless clone_line_table">
        ...
        <tr>
            <td><strong>{{ __('Total TAX/GST') }}</strong></td>
        ...
        <tr>
            ...
            <td>: <strong>{{single_price($actualtotal + $shippingtotal  + $gstAmountTotal)}}</strong></td>
