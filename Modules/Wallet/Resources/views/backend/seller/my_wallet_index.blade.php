                ...
                <a class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2 text-nowrap">{{ single_price(seller_wallet_balance_running()) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2 text-nowrap">{{ single_price(seller_wallet_balance_pending()) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2 text-nowrap">{{ single_price(auth()->user()->wallet_balances->where('type', 'Sale Payment')->sum('amount')) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2 text-nowrap">{{ single_price(auth()->user()->wallet_balances->where('type', 'Withdraw')->sum('amount')) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <a class="d-block">
                    <div class="white-box single-summery">
                        <div class="d-flex justify-content-between">
                            ...
                            <h1 class="gradient-color2 text-nowrap">{{ single_price(auth()->user()->wallet_balances->where('type', 'Refund')->sum('amount')) }}</h1>
                        </div>
                    </div>
                </a>
            </div>
