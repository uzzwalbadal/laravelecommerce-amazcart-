        ...
        <div class="row justify-content-between">
            ...
            <div class="col-lg-6 col-xl-5">
                <div class="product_details">
                                ...
                                @foreach($product->skus as $sku)
                                    @if ($sku->sku->variant_image)
                                        <div class="sku_img_div">
                                            <img src="{{showImage($sku->sku->variant_image)}}" alt="#" class="img-fluid p-1 var_img_source" title="{{ $sku->sku->sku }}"/>
                                        </div>
                                    @endif
                                @endforeach
                            </div>
                    ...
                    @else
                        <input type="hidden" name="shipping_type" id="shipping_type" value="{{@$product->product->shippingMethods[0]->shippingMethod->id}}">
                    @endif --}}
                                        ...
                                        @foreach ($up_sale->up_seller_products->take(2) as $key => $up_seller_product)
                                            ...
                                            <div class="single_related_product media_style">
                                                <div class="single_product_img">
                                                    ...
                                                    <a href="{{singleProductURL($up_seller_product->seller->slug, $up_seller_product->slug)}}" target="_blank"><i class="ti-bag"></i></a>
                                                </div>
                                                <div class="single_product_text align-self-center related_product_width">
                                                    <a href="{{singleProductURL($up_seller_product->seller->slug, $up_seller_product->slug)}}" target="_blank">{{ @$up_seller_product->product_name?@$up_seller_product->product_name:@$up_seller_product->product->product_name }}</a>
                                            ...
                                            <div class="single_related_product media_style">
                                                <div class="single_product_img">
                                                    <img src="
                                                        ...
                                                        @endif
                                                    " alt="#" class="img-fluid var_img_show" />
                                                    <a href="{{singleProductURL($cross_seller_product->seller->slug, $cross_seller_product->slug)}}" target="_blank"><i class="ti-bag"></i></a>
                                                </div>
                                                <div class="single_product_text align-self-center related_product_width">
                                                    <a href="{{singleProductURL($cross_seller_product->seller->slug, $cross_seller_product->slug)}}" target="_blank">{{ @$cross_seller_product->product_name?@$cross_seller_product->product_name:@$cross_seller_product->product->product_name }}</a>
                                                    <div class="category_product_price">
                                                        <h4>
