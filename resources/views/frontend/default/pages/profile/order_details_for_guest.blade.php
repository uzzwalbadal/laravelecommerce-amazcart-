                                        ...
                                        @if ($package_product->type == "gift_card")
                                            <div class="single_order_item">
                                                <div class="order_item_name">
                                                    ...
                                                    <p>
                                                        {{ \Illuminate\Support\Str::limit(@$package_product->giftCard->name, 14, $end='...') }} [ Check Shipping email for secret key]
                                                    </p>
                                                </div>
                                        ...
                                        @else
                                            <div class="single_order_item">
                                                <div class="order_item_name">
                                                    ...
                                                    @endif
                                                    <p>{{ @$package_product->seller_product_sku->product->product_name? \Illuminate\Support\Str::limit(@$package_product->seller_product_sku->product->product_name, 18, $end='...') : \Illuminate\Support\Str::limit(@$package_product->seller_product_sku->sku->product->product_name, 18, $end='...') }}</p>
