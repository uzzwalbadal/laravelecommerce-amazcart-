                ...
                <div class="white_box_50px box_shadow_white mb-20">
                        ...
                        <div class="col-lg-3">
                            <div class="primary_input mb-15">
                                <label class="primary_input_label" for="">
                                    {{ __('product.minimum_order_qty') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="primary_input mb-25">
                                            <select name="choice_options_{{ $choice_option->attribute_id }}[]"
                                                id="choice_options" class="primary_select mb-15 choice_attributes" multiple>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 digital_file_upload_div_edit" style="display: {{$product->is_physical == 0?'block':'none'}}">
                            <div class="primary_input mb-25">
                                <label class="primary_input_label" for="">{{ __('product.program_file_upload') }}
                                    ...
                                    <small> <a class="link_color" href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}"
                                            download>Download Link</a> </small>
                                    @endif
                                </label>
                                <div class="primary_file_uploader">
                                    ...
                                    <button class="" type="button">
                                        <label class="primary-btn small fix-gr-bg"
                                            for="digital_file">{{ __('product.Browse') }} </label>
                        ...
                        <div class="col-lg-6 selling_price_div">
                            <div class="primary_input mb-15">
                                <label class="primary_input_label" for="">
                                    {{ __('product.selling_price') }} <span class="text-danger">*</span></label>
                                <input class="primary_input_field" name="selling_price" id="selling_price"
                                    ...
                                    value="{{ $product->skus->first()->selling_price }}">
                        ...
                        <div class="col-lg-4">
                            ...
                            <p class="cp" aria-disabled="true" id="delete_meta_img" data-id="{{ $product->id }}"><i
                                    class="fas fa-times img_cross"></i></p>
                            @endif
                            ...
                            <div class="primary_input mb-25">
                                ...
                                <div class="primary_file_uploader">
                                    ...
                                    <button class="" type="button">
                                        ...
                                        <input type="file" class="d-none" name="galary_image[]" accept="image/*" id="galary_image"
                                            multiple>
                                    </button>
                                </div>
                            </div>
...
{{--                            <div class="primary_input mb-25">--}}
{{--                                <label class="primary_input_label" for="">{{ __('shipping.shipping_method') }}--}}
{{--                                    <span class="text-danger">*</span></label>--}}
...
{{--                        @endif--}}
                        ...
                        <div class="col-lg-12">
                            <div class="primary_input mb-25">
                                ...
                                <select class="primary_select mb-25" name="video_provider" id="video_provider">
                                    ...
                                    <option value="daily_motion" @if ($product->video_provider == 'daily_motion')
                                        selected @endif>
                        ...
                        <div class="col-12 text-center">
                            <button class="primary_btn_2 mt-5 text-center saveBtn"><i
...
<script type="text/javascript">
    (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('click', '#delete_meta_img', function(event){
                ...
                $(document).on('click','.saveBtn',function() {
                    ...
                    if($('#is_physical').is(":checked")){
                        if ($("#weight").val() === '') {
                            requireMatch = 1;
                            $('#error_weight').text("{{ __('product.please_input_product_weight') }}");
                        }
                        if ($("#breadth").val() === '') {
                            requireMatch = 1;
                            $('#error_length').text("{{ __('product.please_input_product_breadth') }}");
                        }
                        if ($("#length").val() === '') {
                            requireMatch = 1;
                            $('#error_breadth').text("{{ __('product.please_input_product_length') }}");
                        }
                        if ($("#height").val() === '') {
                            requireMatch = 1;
                            $('#error_height').text("{{ __('product.please_input_product_height') }}");
                        }
                    }
                    ...
                    {{--if ($("#shipping_methods").val().length < 1 && $('#is_physical').is(":checked")) {--}}
                    {{--    requireMatch = 1;--}}
                    ...
                    if ($('#product_type').val() === '2' && $(".choice_attributes").val().length === 0) {
                        requireMatch = 1;
